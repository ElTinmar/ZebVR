...
PROTOCOL_WIDGETS: List[Tuple[Type[ProtocolItemWidget], Stim]] = [
    ...
    (visual.PhototaxisWidget, Stim.PHOTOTAXIS_CLOSED_LOOP),
    (visual.OKR_Widget, Stim.OKR_CLOSED_LOOP),
    (visual.OMR_Widget, Stim.OMR_CLOSED_LOOP),
    (visual.DotWidget, Stim.DOT),
    (visual.FollowingDotWidget, Stim.DOT_CLOSED_LOOP),
    ...
    (visual.FollowingPreyCaptureWidget, Stim.PREY_CAPTURE_CLOSED_LOOP),
