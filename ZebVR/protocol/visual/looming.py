...
class LinearRadiusLooming(VisualProtocolItem):

    STIM_SELECT = Stim.LINEAR_RADIUS_LOOMING
...
class LinearRadiusLoomingCL(LinearRadiusLooming):
    STIM_SELECT = Stim.LINEAR_RADIUS_LOOMING_CLOSED_LOOP

class LinearAngleLooming(VisualProtocolItem):

    STIM_SELECT = Stim.LINEAR_ANGLE_LOOMING
...
class LinearAngleLoomingCL(LinearAngleLooming):
    STIM_SELECT = Stim.LINEAR_ANGLE_LOOMING_CLOSED_LOOP

class ConstantApproachSpeedLooming(VisualProtocolItem):

    STIM_SELECT = Stim.CONSTANT_APPROACH_SPEED_LOOMING
...
class ConstantApproachSpeedLoomingCL(ConstantApproachSpeedLooming):
    STIM_SELECT = Stim.CONSTANT_APPROACH_SPEED_LOOMING_CLOSED_LOOP

class LinearRadiusLoomingWidget(VisualProtocolItemWidget):
    ...
    def from_protocol_item(self, protocol_item: ProtocolItem) -> None:
        ...
        if isinstance(protocol_item, LinearRadiusLooming):
    ...
    def to_protocol_item(self) -> LinearRadiusLooming:
...
class LinearRadiusLoomingCL_Widget(LinearRadiusLoomingWidget):
    
    group_name: str = 'Looming parameters'

    def to_protocol_item(self) -> LinearRadiusLoomingCL:
        ...
        protocol = LinearRadiusLoomingCL(
            foreground_color = foreground_color,
            background_color = background_color,
            looming_center_mm = (
                self.sb_looming_center_mm_x.value(),
...
class LinearAngleLoomingWidget(VisualProtocolItemWidget):
    ...
    def from_protocol_item(self, protocol_item: ProtocolItem) -> None:
        ...
        if isinstance(protocol_item, LinearAngleLooming):
            self.sb_looming_center_mm_x.setValue(protocol_item.looming_center_mm[0])
            self.sb_looming_center_mm_y.setValue(protocol_item.looming_center_mm[1])
            self.sb_looming_period_sec.setValue(protocol_item.looming_period_sec)
            self.sb_looming_expansion_time_sec.setValue(protocol_item.looming_expansion_time_sec)
    ...
    def to_protocol_item(self) -> LinearAngleLooming:
...
class LinearAngleLoomingCL_Widget(LinearAngleLoomingWidget):
    
    group_name: str = 'Looming parameters'

    def to_protocol_item(self) -> LinearAngleLoomingCL:
...
class ConstantApproachSpeedLoomingWidget(VisualProtocolItemWidget):
    ...
    def from_protocol_item(self, protocol_item: ProtocolItem) -> None:
        ...
        if isinstance(protocol_item, ConstantApproachSpeedLooming):
            self.sb_looming_center_mm_x.setValue(protocol_item.looming_center_mm[0])
            self.sb_looming_center_mm_y.setValue(protocol_item.looming_center_mm[1])
    ...
    def to_protocol_item(self) -> ConstantApproachSpeedLooming:
        ...
        protocol = ConstantApproachSpeedLooming(
            foreground_color = foreground_color,
            background_color = background_color,
            looming_center_mm = (
                self.sb_looming_center_mm_x.value(),
...
class ConstantApproachSpeedLoomingCL_Widget(ConstantApproachSpeedLoomingWidget):
    
    group_name: str = 'Looming parameters'

    def to_protocol_item(self) -> ConstantApproachSpeedLoomingCL:
        ...
        protocol = ConstantApproachSpeedLoomingCL(
            foreground_color = foreground_color,
            background_color = background_color,
            looming_center_mm = (
                self.sb_looming_center_mm_x.value(),
...
if __name__ == '__main__':
    ...
    app = QApplication([])
    window1 = LinearRadiusLoomingWidget(
    ...
    window1.show()
    window2 = LinearRadiusLoomingCL_Widget(
        looming_center_mm = (0,0),
        looming_period_sec = 10,
        looming_expansion_time_sec = 10,
        looming_expansion_speed_deg_per_sec = 10,
