...
class BrightnessRamp(ProtocolItem):
    ...
    def __init__(
            ...
            ramp_speed_percent_per_sec: float = DEFAULT['ramp_speed_percent_per_sec'],
        ...
        self.ramp_speed_percent_per_sec = ramp_speed_percent_per_sec
    ...
    def start(self) -> Dict:
        ...
        command = {
            ...
            'ramp_speed_percent_per_sec': self.ramp_speed_percent_per_sec,
