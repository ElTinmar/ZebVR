...
class TrackerWidget(QWidget):
    ...
    def declare_components(self):
        ...
        self.animal_crop_width_mm.setText('crop width')
        self.animal_crop_width_mm.setRange(0.5,100)
        ...
        self.animal_crop_height_mm.setText('crop height')
        self.animal_crop_height_mm.setRange(0.5,100)
