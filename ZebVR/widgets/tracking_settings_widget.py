...
# TODO partition this a bit more?
class TrackerWidget(QWidget):
    ...
    def declare_components(self):
        ...
        self.animal_crop_offset_y_mm.valueChanged.connect(self.on_change)

        self.animal_crop_width_mm = LabeledDoubleSpinBox()
        self.animal_crop_width_mm.setText('crop width (mm)')
        self.animal_crop_width_mm.setRange(0.05,100)
        self.animal_crop_width_mm.setSingleStep(0.05)
        self.animal_crop_width_mm.setValue(9.0)
        self.animal_crop_width_mm.valueChanged.connect(self.on_change)

        self.animal_crop_height_mm = LabeledDoubleSpinBox()
        self.animal_crop_height_mm.setText('crop height (mm)')
        self.animal_crop_height_mm.setRange(0.05,1000)
        self.animal_crop_height_mm.setSingleStep(0.05)
        self.animal_crop_height_mm.setValue(9.0)
        self.animal_crop_height_mm.valueChanged.connect(self.on_change)
        ...
        self.animal_downsample_factor.valueChanged.connect(self.on_change)
        ...
        self.body_crop_offset_y_mm.valueChanged.connect(self.on_change)

        self.body_crop_width_mm = LabeledDoubleSpinBox()
        self.body_crop_width_mm.setText('crop width (mm)')
        self.body_crop_width_mm.setRange(0.05,1000)
        ...
        self.body_crop_height_mm.setRange(0.05,1000)
        ...
        self.eyes_crop_offset_y_mm.valueChanged.connect(self.on_change)

        self.eyes_crop_width_mm = LabeledDoubleSpinBox()
        self.eyes_crop_width_mm.setText('crop width (mm)')
        self.eyes_crop_width_mm.setRange(0.05,1000)
        ...
        self.eyes_crop_height_mm.setRange(0.05,1000)
        ...
        self.tail_crop_offset_y_mm.valueChanged.connect(self.on_change)

        self.tail_crop_width_mm = LabeledDoubleSpinBox()
        self.tail_crop_width_mm.setText('crop width (mm)')
        self.tail_crop_width_mm.setRange(0.05,1000)
        ...
        self.tail_crop_height_mm.setRange(0.05,1000)
    ...
    def get_state(self) -> Dict:
        ...
        state['animal_tracking']['intensity']=self.animal_intensity.value()
        state['animal_tracking']['gamma']=self.animal_gamma.value()
        state['animal_tracking']['contrast']=self.animal_contrast.value()
        state['animal_tracking']['min_size_mm']=self.animal_min_size_mm.value()
        state['animal_tracking']['max_size_mm']=self.animal_max_size_mm.value()
        state['animal_tracking']['min_length_mm']=self.animal_min_length_mm.value()
        state['animal_tracking']['max_length_mm']=self.animal_max_length_mm.value()
        state['animal_tracking']['min_width_mm']=self.animal_min_width_mm.value()
        state['animal_tracking']['max_width_mm']=self.animal_max_width_mm.value()
        ...
        state['animal_tracking']['downsample_factor']=self.animal_downsample_factor.value()
        state['animal_tracking']['crop_offset_y_mm']=self.animal_crop_offset_y_mm.value()
        state['animal_tracking']['crop_dimension_mm']=(self.animal_crop_width_mm.value(),self.animal_crop_height_mm.value())
        ...
        state['body_tracking']['intensity']=self.body_intensity.value()
        state['body_tracking']['gamma']=self.body_gamma.value()
        state['body_tracking']['contrast']=self.body_contrast.value()
        state['body_tracking']['min_size_mm']=self.body_min_size_mm.value()
        state['body_tracking']['max_size_mm']=self.body_max_size_mm.value()
        state['body_tracking']['min_length_mm']=self.body_min_length_mm.value()
        state['body_tracking']['max_length_mm']=self.body_max_length_mm.value()
        state['body_tracking']['min_width_mm']=self.body_min_width_mm.value()
        state['body_tracking']['max_width_mm']=self.body_max_width_mm.value()
        state['body_tracking']['crop_offset_y_mm']=self.body_crop_offset_y_mm.value()
        ...
        state['eyes_tracking']['thresh_lo']=self.eyes_intensity_lo.value()
        state['eyes_tracking']['thresh_hi']=self.eyes_intensity_hi.value()
        state['eyes_tracking']['dyntresh_res']=self.eyes_thresh_resolution.value()
        state['eyes_tracking']['gamma']=self.eyes_gamma.value()
        state['eyes_tracking']['contrast']=self.eyes_contrast.value()
        state['eyes_tracking']['size_lo_mm']=self.eyes_min_size_mm.value()
        state['eyes_tracking']['size_hi_mm']=self.eyes_max_size_mm.value()
        state['eyes_tracking']['crop_offset_y_mm']=self.eyes_crop_offset_y_mm.value()
        ...
        state['tail_tracking']['gamma']=self.tail_gamma.value()
        state['tail_tracking']['contrast']=self.tail_contrast.value()
        ...
        state['tail_tracking']['crop_offset_y_mm']=self.tail_crop_offset_y_mm.value()
    ...
    def set_state(self, state:Dict) -> None:
        ...
        self.animal_intensity.setValue(state['animal_tracking']['intensity'])
        self.animal_gamma.setValue(state['animal_tracking']['gamma'])
        self.animal_contrast.setValue(state['animal_tracking']['contrast'])
        self.animal_min_size_mm.setValue(state['animal_tracking']['min_size_mm'])
        self.animal_max_size_mm.setValue(state['animal_tracking']['max_size_mm'])
        self.animal_min_length_mm.setValue(state['animal_tracking']['min_length_mm'])
        self.animal_max_length_mm.setValue(state['animal_tracking']['max_length_mm'])
        self.animal_min_width_mm.setValue(state['animal_tracking']['min_width_mm'])
        self.animal_max_width_mm.setValue(state['animal_tracking']['max_width_mm'])
        self.animal_crop_offset_y_mm.setValue(state['animal_tracking']['crop_offset_y_mm'])
        self.animal_crop_width_mm.setValue(state['animal_tracking']['crop_dimension_mm'][0])
        self.animal_crop_height_mm.setValue(state['animal_tracking']['crop_dimension_mm'][1])
        ...
        self.animal_downsample_factor.setValue(state['animal_tracking']['downsample_fullres'])
        ...
        self.body_intensity.setValue(state['body_tracking']['intensity'])
        self.body_gamma.setValue(state['body_tracking']['gamma'])
        self.body_contrast.setValue(state['body_tracking']['contrast'])
        self.body_min_size_mm.setValue(state['body_tracking']['min_size_mm'])
        self.body_max_size_mm.setValue(state['body_tracking']['max_size_mm'])
        self.body_min_length_mm.setValue(state['body_tracking']['min_length_mm'])
        self.body_max_length_mm.setValue(state['body_tracking']['max_length_mm'])
        self.body_min_width_mm.setValue(state['body_tracking']['min_width_mm'])
        self.body_max_width_mm.setValue(state['body_tracking']['max_width_mm'])
        self.body_crop_offset_y_mm.setValue(state['body_tracking']['crop_offset_y_mm'])
        ...
        self.eyes_intensity_lo.setValue(state['eyes_tracking']['thresh_lo'])
        self.eyes_intensity_hi.setValue(state['eyes_tracking']['thresh_hi'])
        self.eyes_thresh_resolution.setValue(state['eyes_tracking']['dyntresh_res'])
        self.eyes_gamma.setValue(state['eyes_tracking']['gamma'])
        self.eyes_contrast.setValue(state['eyes_tracking']['contrast'])
        self.eyes_min_size_mm.setValue(state['eyes_tracking']['size_lo_mm'])
        self.eyes_max_size_mm.setValue(state['eyes_tracking']['size_hi_mm'])
        self.eyes_crop_offset_y_mm.setValue(state['eyes_tracking']['crop_offset_y_mm'])
        ...
        self.tail_gamma.setValue(state['tail_tracking']['gamma'])
        self.tail_contrast.setValue(state['tail_tracking']['contrast'])
        ...
        self.tail_crop_offset_y_mm.setValue(state['tail_tracking']['crop_offset_y_mm'])
