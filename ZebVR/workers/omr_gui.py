...
class OMR_GUI(WorkerNode):
    ...
    def initialize(self) -> None:
        ...
        self.window.setWindowTitle('OMR controls')
        self.window.show()
    ...
    def process_metadata(self, metadata: Dict) -> Optional[Dict]:
        ...
        if self.updated:
            ...
            res['visual_stim_control']['omr_grating_speed_deg_per_sec'] = self.speed.value() 
            res['visual_stim_control']['omr_spatial_frequency_deg'] = self.spatial_freq.value()
            self.updated = False
            return res       
        else:
            return None