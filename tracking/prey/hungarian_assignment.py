...
# Adapted from https://github.com/srianant/kalman_filter_multi_object_tracking
...
class Tracker():
    ...
    def update(self, centroids):
        ...
        Args:
            centroids: detected centroids of object to be tracked
        Return:
            None
        """
        ...
        if (len(self.tracks) == 0):
            for i in range(len(centroids)):
                track = Track(centroids[i], self.trackIdCount)
                self.trackIdCount += 1
